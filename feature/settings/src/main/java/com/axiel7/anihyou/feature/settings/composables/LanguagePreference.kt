...
/**
 * Upstream language preference plus Kiyori's narrow General-settings extension seam.
 * Keeping the Kiyori block here avoids forking the large upstream SettingsView.
 */
@Composable
